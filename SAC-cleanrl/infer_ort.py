...
def make_env(env_id, seed, idx, capture_video, run_name):
    def thunk():
        if capture_video and idx == 0:
            ...
            env = gym.wrappers.RecordVideo(env, f"videos/SAC-{env_id}-baseline-ort")
        else:
            env = gym.make(env_id)
...
if __name__ == "__main__":
    ...
    session = ort.InferenceSession(f"models/SAC-{args.env_id}.onnx", providers=ort.get_available_providers())
