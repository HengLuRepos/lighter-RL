ffmpeg -i video/TD3-HalfCheetah-v4-baseline-episode-0.mp4 -i video/TD3-HumanoidStandup-v4-baseline-episode-0.mp4 -i video/TD3-Ant-v4-baseline-episode-0.mp4 -i video/TD3-Humanoid-v4-baseline-episode-0.mp4 -i video/TD3-Hopper-v4-baseline-episode-0.mp4 -i video/TD3-HalfCheetah-v4-dynamic-episode-0.mp4 -i video/TD3-HumanoidStandup-v4-qat-episode-0.mp4 -i video/TD3-Ant-v4-dynamic-episode-0.mp4 -i video/TD3-Humanoid-v4-dynamic-episode-0.mp4 -i video/TD3-Hopper-v4-dynamic-episode-0.mp4 -i video/TD3-HalfCheetah-v4-pruning-episode-0.mp4 -i video/TD3-HumanoidStandup-v4-pruning-episode-0.mp4 -i video/TD3-Ant-v4-pruning-episode-0.mp4 -i video/TD3-Humanoid-v4-pruning-episode-0.mp4 -i video/TD3-Hopper-v4-pruning-episode-0.mp4 -filter_complex "color=c=black:size=2880x1920[bg]; \
...
drawtext=text='TD3':x=(W/12)-(text_w/2):y=(H/8)-(text_h/2):fontsize=24:fontcolor=white, \
