...
origin_session = ort.InferenceSession(f"models/TRPO-{config.env}.onnx", providers=ort.get_available_providers())
...
quantized_model = quantize_static(model_input=f"models/onnxQuant/TRPO-{config.env}-prep.onnx", 
                                  model_output=f"models/onnxQuant/TRPO-{config.env}-static.onnx",
