...
origin_session = ort.InferenceSession(f"models/TRPO-{config.env_name}-seed-1.onnx", providers=ort.get_available_providers())
...
quantized_model = quantize_static(model_input=f"models/onnxQuant/TRPO-{config.env_name}-prep.onnx", 
                                  model_output=f"models/onnxQuant/TRPO-{config.env_name}-static.onnx",
