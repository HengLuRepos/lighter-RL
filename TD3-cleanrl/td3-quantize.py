...
"""
    ...
    actor.load_model(f"models/td3-{args.env_id}-seed-{args.seed}-actor.pt")
    ...
    actor_int8.save_model(f"models/qat/td3-{args.env_id}-seed-{args.seed}-actor-x86.pt")
    all_state_dict = {
        ...
        'actor_target': target_actor_int8.state_dict()
    }
    actor.save_model(f"models/td3-{args.env_id}-seed-{args.seed}-actor.pt")
    torch.save(all_state_dict, f"models/td3-{args.env_id}-seed-{args.seed}.pt")