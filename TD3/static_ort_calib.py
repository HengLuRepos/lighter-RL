...
origin_session = ort.InferenceSession(f"models/TD3-{config.env}.onnx", providers=ort.get_available_providers())
...
quantized_model = quantize_static(model_input=f"models/onnxQuant/TD3-{config.env}-prep.onnx", 
                                  model_output=f"models/onnxQuant/TD3-{config.env}-static.onnx",
