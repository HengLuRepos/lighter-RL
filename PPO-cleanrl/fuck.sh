ffmpeg -i PPO-HalfCheetah-v4-baseline-ort/rl-video-episode-0.mp4 -i PPO-HumanoidStandup-v4-baseline-ort/rl-video-episode-0.mp4 -i PPO-Ant-v4-baseline-ort/rl-video-episode-0.mp4 -i PPO-Humanoid-v4-baseline-ort/rl-video-episode-0.mp4 -i PPO-Hopper-v4-baseline-ort/rl-video-episode-0.mp4 -i PPO-HalfCheetah-v4-dynamic/rl-video-episode-0.mp4 -i PPO-HumanoidStandup-v4-dynamic/rl-video-episode-0.mp4 -i PPO-Ant-v4-dynamic/rl-video-episode-0.mp4 -i PPO-Humanoid-v4-static/rl-video-episode-0.mp4 -i PPO-Hopper-v4-qat/rl-video-episode-0.mp4 -i PPO-HalfCheetah-v4-pruning/rl-video-episode-0.mp4 -i PPO-HumanoidStandup-v4-pruning/rl-video-episode-0.mp4 -i PPO-Ant-v4-pruning/rl-video-episode-0.mp4 -i PPO-Humanoid-v4-pruning/rl-video-episode-0.mp4 -i PPO-Hopper-v4-pruning/rl-video-episode-0.mp4 -filter_complex "color=c=black:size=2880x1920[bg]; \
...
drawtext=text='PPO':x=(W/12)-(text_w/2):y=(H/8)-(text_h/2):fontsize=24:fontcolor=white, \
